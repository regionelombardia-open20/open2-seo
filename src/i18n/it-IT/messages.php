...
return [
    ...
    '#og_description_field_placeholder' => 'Inserisci l\'og-description',
    '#og_description_field_hint' => 'Se il campo è lasciato vuoto, viene usato come default la meta description',
    //'#og_type_field_placeholder' => 'Inserisci l\'og-type',
    '#og_type_field_prompt' => 'Scegli l\'og-type',
    '#og_type_field_hint' => ' ',
    '#og_image_field' => 'Og Image',
    '#og_image_field_hint' => ' ',

    '#robot_tag_title' => 'Robot tag',
    '#meta_robots_field_hint' => ' ',
    '#meta_googlebot_field_hint' => ' ',
    '#noindex_desc' => 'noindex: impedisce l\'indicizzazione della pagina.',
    '#nofollow_desc' => 'nofollow: impedisce che Googlebot segua i link della pagina.',
    '#nosnippet_desc' => 'nosnippet: impedisce la visualizzazione di uno snippet di testo nei risultati di ricerca. Per i video, viene mostrata un\'immagine statica, se possibile.',
